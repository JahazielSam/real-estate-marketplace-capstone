...
import '/home/hep-cbe-295/Downloads/Blockchain-Capstone-master/node_modules/openzeppelin-solidity/contracts/utils/~Address.sol';
import '/home/hep-cbe-295/Downloads/Blockchain-Capstone-master/node_modules/openzeppelin-solidity/contracts/drafts/~Counters.sol';
import '/home/hep-cbe-295/Downloads/Blockchain-Capstone-master/node_modules/openzeppelin-solidity/contracts/math/~SafeMath.sol';
import '/home/hep-cbe-295/Downloads/Blockchain-Capstone-master/node_modules/openzeppelin-solidity/contracts/token/ERC721/~IERC721Receiver.sol';
import "./~Oraclize.sol";
...
modifier whenNotPaused{
  if(_paused == false){
    ...
    revert();
    //("This runs if the contract is not operational")
  }
  emit ISUnpaused(msg.sender);
  _;
}
modifier paused {
  if(_paused == true){
    ...
    revert();
    //("This runs if the contract is operational")
  }
  emit IsPaused(msg.sender);
  _;
}
//  5) create a Paused & Unpaused event that emits the address that triggered the event
event IsPaused(address indexed caller);
event ISUnpaused(address indexed caller);
}
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        require(_exists(tokenId), "There is no such token.");
